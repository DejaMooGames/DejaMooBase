...
namespace DejaMoo.Extensions
{
    public static class VectorExtensionMethods
    {
        ...
        public static bool ApproxAngle(this Vector3 posA, Vector3 posB, float tolerance)
        {
            return Vector3.Dot(posA, posB) > 1 - tolerance;
        }

        public static bool ApproxPos(this Vector3 posA, Vector3 posB, float tolerance)
        {
            return (posA - posB).sqrMagnitude < tolerance * tolerance;
        }

        public static Vector3 DiagonalVector(float f)
        {
